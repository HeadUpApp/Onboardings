                    ...
                    VStack {
                        ZStack {
                            HStack{
                                ...
                                Button {
                                    ...
                                    Image(bundleResource: "closeButton")
                                        .resizable()
                            ...
                            Image(bundleResource: "beforeAfter")
                                .resizable()
                                .scaledToFit()
                        ...
                        ZStack(alignment: .leading) {
                            ...
                            VStack(alignment: .leading, spacing: 22) {
                                ...
                                HStack(alignment: .top, spacing: 20) {
                                    Image(bundleResource: "zvonochek")
                                        .resizable()
                                        .frame(width: 40, height: 40)
                                ...
                                HStack(alignment: .top, spacing: 20) {
                                    Image(bundleResource: "paywallZvezda")
                                        .resizable()
                                        .frame(width: 40, height: 40)
